...
def plot_metadata_counts(
    ...
    try:
        ...
        if plot_type == 'bar':
            ...
            # Plot data
            ax.plot(angles, values, 'o-', linewidth=2, color=colors if isinstance(colors, str) else 'blue')
            ax.fill(angles, values, alpha=0.25, color=colors if isinstance(colors, str) else 'blue')
