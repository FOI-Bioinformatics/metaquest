...
class TestSRADatasetAnalyzer:
    ...
    def test_compare_datasets(self):
        ...
        groups = {
            'group1': ['SRR123456', 'SRR123457'],
            'group2': ['SRR789012', 'SRR789013']
        }
        
        # Mock profile generation
        mock_profiles = {
            'SRR123456': QualityProfile(
                accession='SRR123456', total_reads=10000, total_bases=1500000,
                avg_read_length=150, read_length_distribution={}, gc_content=0.45,
                gc_distribution=[], quality_distribution={}, n_content=0.01,
                contamination_indicators={'adapter_contamination': 0.02}, complexity_score=0.7,
                duplication_rate=None, technology_confidence=0.9, quality_grade='good',
                recommendations=[]
            ),
            'SRR123457': QualityProfile(
                accession='SRR123457', total_reads=12000, total_bases=1800000,
                avg_read_length=150, read_length_distribution={}, gc_content=0.48,
                gc_distribution=[], quality_distribution={}, n_content=0.015,
                contamination_indicators={'adapter_contamination': 0.025}, complexity_score=0.75,
                duplication_rate=None, technology_confidence=0.85, quality_grade='good',
                recommendations=[]
            ),
            'SRR789012': QualityProfile(
                accession='SRR789012', total_reads=8000, total_bases=1200000,
                avg_read_length=150, read_length_distribution={}, gc_content=0.42,
                gc_distribution=[], quality_distribution={}, n_content=0.008,
                contamination_indicators={'adapter_contamination': 0.03}, complexity_score=0.65,
                duplication_rate=None, technology_confidence=0.88, quality_grade='fair',
                recommendations=[]
            ),
            'SRR789013': QualityProfile(
                accession='SRR789013', total_reads=9000, total_bases=1350000,
                avg_read_length=150, read_length_distribution={}, gc_content=0.40,
                gc_distribution=[], quality_distribution={}, n_content=0.012,
                contamination_indicators={'adapter_contamination': 0.035}, complexity_score=0.68,
                duplication_rate=None, technology_confidence=0.82, quality_grade='fair',
                recommendations=[]
            )
        }
    ...
    def test_detect_dataset_anomalies(self):
        ...
        mock_profiles = {
            ...
            'SRR789012': QualityProfile(  # Anomalous dataset - high contamination
                accession='SRR789012', total_reads=8000, total_bases=1200000,
                avg_read_length=150, read_length_distribution={}, gc_content=0.15,  # Unusual GC
                gc_distribution=[], quality_distribution={}, n_content=0.08,  # High N
                contamination_indicators={'adapter_contamination': 0.15}, complexity_score=0.05,  # Low complexity
                duplication_rate=None, technology_confidence=0.6, quality_grade='poor',
                recommendations=[]
            ),
            'SRR555555': QualityProfile(  # Normal dataset
                accession='SRR555555', total_reads=11000, total_bases=1650000,
                avg_read_length=150, read_length_distribution={}, gc_content=0.42,
                gc_distribution=[], quality_distribution={}, n_content=0.012,
                contamination_indicators={'adapter_contamination': 0.018}, complexity_score=0.72,
                duplication_rate=None, technology_confidence=0.88, quality_grade='good',
                recommendations=[]
            )
        }
    ...
    def test_recommend_processing_params(self):
        ...
        test_profile = QualityProfile(
            ...
            avg_read_length=150, read_length_distribution={}, gc_content=0.45,
            gc_distribution=[], quality_distribution={}, n_content=0.01,
            contamination_indicators={'adapter_contamination': 0.08}, complexity_score=0.7,
            duplication_rate=None, technology_confidence=0.9, quality_grade='fair',
            recommendations=[]
        )
...
class TestStatisticalAnalysis:
    ...
    def test_generate_comparative_recommendations(self):
        ...
        summary_stats = {
            'group_A': {'avg_read_length': {'mean': 150}},
            'group_B': {'avg_read_length': {'mean': 250}}
        }
        
        statistical_tests = {
            'avg_read_length': {'significant': True, 'p_value': 0.001}
        }
