...
class TestFilterSamplesByContainment:
    ...
    def test_filter_samples_by_max_containment(self, tmp_path):
        ...
        result = filter_samples_by_containment(summary_file, threshold=0.65, genome_id=None)
    ...
    def test_filter_samples_missing_genome(self, tmp_path):
        ...
        with pytest.raises(ProcessingError, match="Genome MISSING not found in summary file"):
            filter_samples_by_containment(summary_file, threshold=0.5, genome_id="MISSING")
    ...
    def test_filter_samples_no_matches(self, tmp_path):
        ...
        result = filter_samples_by_containment(summary_file, threshold=0.95, genome_id="GCF_000001.1")
    ...
    def test_filter_samples_string_path(self, tmp_path):
        ...
        result = filter_samples_by_containment(str(summary_file), threshold=0.5, genome_id="GCF_000001.1")
...
class TestFindCoOccurringGenomes:
    ...
    def test_find_co_occurring_genomes_success(self, tmp_path):
        ...
        result = find_co_occurring_genomes(summary_file, threshold=0.5, min_samples=3)
    ...
    def test_find_co_occurring_genomes_no_frequent_genomes(self, tmp_path):
        ...
        result = find_co_occurring_genomes(summary_file, threshold=0.5, min_samples=10)
    ...
    def test_find_co_occurring_genomes_no_genome_columns(self, tmp_path):
        ...
        invalid_data = pd.DataFrame(
            {"max_containment": [0.8, 0.7], "max_containment_annotation": ["A", "B"]}, index=["SRR001", "SRR002"]
        )
    ...
    def test_find_co_occurring_genomes_high_threshold(self, tmp_path):
        ...
        result = find_co_occurring_genomes(summary_file, threshold=0.85, min_samples=1)
    ...
    def test_find_co_occurring_genomes_string_path(self, tmp_path):
        ...
        result = find_co_occurring_genomes(str(summary_file), threshold=0.5, min_samples=3)
